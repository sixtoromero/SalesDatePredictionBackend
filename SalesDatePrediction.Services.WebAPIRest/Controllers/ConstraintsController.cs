...
namespace SalesDatePrediction.Services.WebAPIRest.Controllers
{
    ...
    {
        private readonly IConstraintsApplication _Application;
        private readonly AppSettings _appSettings;
        private readonly IWebHostEnvironment env;

        public ConstraintsController(IConstraintsApplication _Application,
        ...
        {
            Response<IEnumerable<ConstraintsDTO>> response = new Response<IEnumerable<ConstraintsDTO>>();
        ...
        {
            Response<ConstraintsDTO> response = new Response<ConstraintsDTO>();
        ...
        [HttpPost("MassConstraintsRegistrationAsync")]
        public async Task<IActionResult> MassConstraintsRegistrationAsync(int TableId, int UserId)
        {
            Response<bool> response = new Response<bool>();

            try
            {
                response = await _Application.MassConstraintsRegistrationAsync(TableId, UserId);
                if (response.IsSuccess)
                {
                    return Ok(response);
                }
        ...
        public async Task<IActionResult> InsertAsync(ConstraintsDTO modelDto)
        {
            Response<bool> response = new Response<bool>();
        ...
        [Produces("application/json")]
        [HttpPut("UpdateAsync")]
        public async Task<IActionResult> UpdateAsync(ConstraintsDTO modelDto)
        {
            Response<bool> response = new Response<bool>();
