...
namespace SalesDatePrediction.Services.WebAPIRest.Controllers
{
    ...
    {
        private readonly IIndexesApplication _Application;
        private readonly AppSettings _appSettings;
        private readonly IWebHostEnvironment env;

        public IndexesController(IIndexesApplication _Application,
        ...
        {
            Response<IEnumerable<IndexesDTO>> response = new Response<IEnumerable<IndexesDTO>>();
        ...
        {
            Response<IndexesDTO> response = new Response<IndexesDTO>();
        ...
        [HttpPost("MassIndexesRegistrationAsync")]
        public async Task<IActionResult> MassIndexesRegistrationAsync(RequestGenDTO model)
        {
            Response<bool> response = new Response<bool>();

            try
            {
                response = await _Application.MassIndexesRegistrationAsync(model.GeneralId, model.UserId);
                if (response.IsSuccess)
                {
                    return Ok(response);
                }
        ...
        public async Task<IActionResult> InsertAsync(IndexesDTO modelDto)
        {
            Response<bool> response = new Response<bool>();
        ...
        [Produces("application/json")]
        [HttpPut("UpdateAsync")]
        public async Task<IActionResult> UpdateAsync(IndexesDTO modelDto)
        {
            Response<bool> response = new Response<bool>();
