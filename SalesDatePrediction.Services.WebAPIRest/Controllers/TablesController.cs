...
namespace SalesDatePrediction.Services.WebAPIRest.Controllers
{
    ...
    {
        private readonly ITablesApplication _Application;
        private readonly AppSettings _appSettings;
        private readonly IWebHostEnvironment env;

        public TablesController(ITablesApplication _Application,
        ...
        {
            Response<IEnumerable<TablesDTO>> response = new Response<IEnumerable<TablesDTO>>();
        ...
        {
            Response<TablesDTO> response = new Response<TablesDTO>();
        ...
        [HttpPost("MassTableRegistrationAsync")]
        public async Task<IActionResult> MassTableRegistrationAsync(RequestGenDTO model)
        {
            Response<bool> response = new Response<bool>();

            try
            {
                response = await _Application.MassTableRegistrationAsync(model.GeneralId, model.UserId);
                if (response.IsSuccess)
                {
                    return Ok(response);
                }
        ...
        public async Task<IActionResult> InsertAsync(TablesDTO modelDto)
        {
            Response<bool> response = new Response<bool>();
        ...
        [Produces("application/json")]
        [HttpPut("UpdateAsync")]
        public async Task<IActionResult> UpdateAsync(TablesDTO modelDto)
        {
            Response<bool> response = new Response<bool>();
